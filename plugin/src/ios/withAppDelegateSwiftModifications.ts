...
import {
  ...
  CIO_INITIALIZE_SDK_SNIPPET,
  CIO_APP_PUSH_NOTIFICATIONS_HANDLER_REGEX,
  CIO_INITIALIZE_SDK_REGEX,
  CIO_OVERRIDE_REMOTE_NOTIFICATION_REGEX,
...
export const withAppDelegateSwiftModifications: ConfigPlugin<
