...
var _withAppDelegateSwiftModifications = require("./withAppDelegateSwiftModifications");
...
function withCIOIos(config, props) {
  ...
  if (cioProps.pushNotification) {
    ...
    config = (0, _withAppDelegateSwiftModifications.withAppDelegateSwiftModifications)(config, cioProps);
...
//# sourceMappingURL=withCIOIos.js.mapmap